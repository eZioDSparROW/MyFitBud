import { AiProgressAnalyzer } from "@/components/ai-progress-analyzer"
      ...
      <div className="container mx-auto py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-600 mb-8">
            Track your fitness journey and get personalized insights to optimize your results and stay motivated.
          </p>
